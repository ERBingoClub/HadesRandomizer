...
{
    public static readonly List<int> StaffIds = new()
    {
        ...
        33510000, // Staff of the Great Beyond (DLC)
        33520000, // Maternal Staff (DLC)
    };

    public static readonly List<int> SealIds = new()
    {
        ...
        34500000, // Dryleaf Seal (DLC)
        34510000, // Fire Knight's Seal (DLC)
        34520000, // Spiraltree Seal (DLC)
    };

    private static readonly HashSet<int> StaffOrSealIds = new(StaffIds.Concat(SealIds));

    public static bool IsStaff(int weaponId) => StaffIds.Contains(weaponId);

    public static bool IsSeal(int weaponId) => SealIds.Contains(weaponId);
}
